...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l auth-choice -d 'Auth: setup-token|token|chutes|openai-codex|openai-[REDACTED]
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l anthropic-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l openai-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l openrouter-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l ai-gateway-[REDACTED]
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l cloudflare-ai-gateway-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l moonshot-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l kimi-code-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l gemini-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l zai-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l xiaomi-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l minimax-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l synthetic-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l venice-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l together-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l opencode-zen-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l xai-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l litellm-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l qianfan-[REDACTED]
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l custom-base-url -d 'Custom provider base URL'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l custom-[REDACTED]
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l channel -d 'Delivery channel (last|whatsapp|googlechat|slack)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l channel -d 'Delivery channel (last|whatsapp|googlechat|slack)'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel (whatsapp, googlechat, slack)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l channel -d 'Channel (whatsapp, googlechat, slack)'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l [REDACTED]
