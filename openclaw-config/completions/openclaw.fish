...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l channel -d 'Delivery channel (last|whatsapp)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l channel -d 'Delivery channel (last|whatsapp)'
